import collections
from .utils import sample_from_references, SimpleTimer, UnknownCandidatesError, mean, harmonic_mean
...
class FormEvaluator:
    ...
    def compile_report(self, candidates, candidate_scores=None, reference_scores=None, path='./report.txt'):
